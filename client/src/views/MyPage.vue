                ...
                <nav class="settings-navigation">
                    ...
                    <router-link v-ripple to="/settings/account" class="account mt-6">
                        <div class="account-wrapper">
                            <img class="account__icon" :src="userStore.user ? (userStore.user_icon_url ?? '') : '/konomitv/assets/images/account-icon-default.png'">
                    ...
                    <v-btn variant="flat" class="settings-navigation__button settings-navigation__button--version mt-3"
                        ...
                        href="https://github.com/yyya-nico/KonomiTV" target="_blank">
